...
## 2b. 第二賽制 sDCI（SVDQuant 論文的另一 prompt 集；同協定張數）——**23/30**

| 模型（樣本） | PSNR↑ | LPIPS↓ | SSIM↑ | FID-ref↓ | FID-GT↓ | 戰績 |
|---|---|---|---|---|---|---|
| FLUX-schnell（1000） | 17.85 / **18.02** | 0.229 / **0.224** | 0.708 / **0.713** | 26.73 / **26.57** | 61.63 / **61.39** | 0:5 |
| FLUX.1-dev（500） | **20.32** / 20.14 | **0.218** / 0.220 | **0.767** / 0.765 | **35.19** / 35.29 | **94.54** / 94.79 | 5:0 |
| PixArt-Σ（2500） | **17.12** / 16.51 | **0.305** / 0.326 | **0.608** / 0.594 | **19.02** / 19.48 | 35.63 / **35.37** | 4:1 |
| SANA-1.6B（2500） | **18.26** / 17.97 | **0.178** / 0.186 | **0.691** / 0.681 | **10.12** / 10.59 | **33.79** / 34.30 | 5:0 |
| SDXL-Turbo（2500） | **19.33** / 18.92 | **0.220** / 0.235 | **0.676** / 0.656 | **11.76** / 12.28 | **36.21** / 36.49 | 5:0 |
| SDXL-base（1000） | **23.74** / 22.76 | **0.193** / 0.231 | **0.773** / 0.747 | **28.53** / 32.13 | 66.92 / **66.86** | 4:1 |
